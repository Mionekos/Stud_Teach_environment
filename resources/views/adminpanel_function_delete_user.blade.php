...
<div class="content-wrapper">
    <ol class="breadcrumb">
        <li class="breadcrumb-item">
            <a href="#">Удаление пользователя</a>
        </li>
    ...
    <div class="container">
        <div class="row">
                <div class="col-md-5">
                    <label class="text_label">Выберите вид пользователя</label>
                    {{--<input type="text" name="lastname_teacher"  class="form-control input_add_data" placeholder="Введите фамилию...">--}}
                    <select id="id_select_delete_user" name="select_delete_user" class="form-control select_course sel_delete">
            ...
            <div class="col-md-5">
                <label class="text_label">Выберите пользователя</label>
                {{--<input type="text" name="post_teacher"  class="form-control input_add_data" placeholder="Введите должность...">--}}
                <select id="id_select_name_user_delete" name="select_name_user_delete" class="form-control select_course sel_delete">
                    <option value="1">1</option>
                    <option value="2">2</option>
