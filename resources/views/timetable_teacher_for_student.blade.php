        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item ">
                ...
                <div class="dropdown-menu" aria-labelledby="messagesDropdown">
                    <a class="dropdown-header" href="{{route("cabinet")}}">
...
<div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <label for="search_group">Поиск:</label>
                        <input type="search" id="search_teacher" name="search_teacher"  class="form-control search_group" placeholder="Поиск...">
                    </div>
                    <div class="col-md-2">
    ...
    <div ><nobr class="table_name">Преподаватель</nobr><br><nobr class="table_date"> (с ... по...)</nobr></div>
    <br>
