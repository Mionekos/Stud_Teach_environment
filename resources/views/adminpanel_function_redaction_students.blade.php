...
<div class="content-wrapper">
    <ol class="breadcrumb">
        <li class="breadcrumb-item">
            <a href="#">Редактирование данных студента</a>
        </li>
            ...
            <div class="container search_user">
                <div class="row">
                    ...
                    <div class="col-md-5">
                        ...
                        <label class="text_label">Введите данные студента</label>
        ...
        <div class="container-fluid" style="position: relative">
            ...
            <div class="container" style="position: absolute; top: 0px;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2"></div>
                    <div class="col-md-5">
                        <input type="text" name="number_group"  class="form-control tables_box" placeholder="Номер группы"/>
                    </div>
                    <div class="col-md-1"></div>
                </div>
                <div class="row">
