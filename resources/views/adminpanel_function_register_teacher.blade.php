...
<div class="content-wrapper">
    <ol class="breadcrumb">
        <li class="breadcrumb-item">
            <a href="#">Регистрация преподавателей</a>
        </li>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-5">
                    <input type="text" name="birthday_teacher"  class="form-control input_add_data" placeholder="Введите дату рождения...">
            </div>
            <div class="col-md-1"></div>
            <div class="col-md-5">
                  <input type="text" name="password_teacher"  class="form-control input_add_data" placeholder="Введите пароль...">
            </div>
            <div class="col-md-1"></div>
        </div>
        <div class="row">
            <div class="col-md-5">
                <input type="text" name="gender_teacher"  class="form-control input_add_data" placeholder="Введите пол...">
            </div>
            <div class="col-md-1"></div>
            <div class="col-md-5">
                <input type="text" name="password_conf_teacher"  class="form-control input_add_data" placeholder="Подтвердите пароль...">
